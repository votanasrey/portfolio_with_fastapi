            ...
            <section className='grid gap-10'>
                ...
                <article className='bg-gray-d relative border-dotted border-2 border-sky-500 rounded-lg overflow-hidden'>
                    ...
                    <section className='p-6'>
                        ...
                        <a href="https://www.linkedin.com/feed/update/urn:li:activity:6904375228529569792/?updateEntityUrn=urn%3Ali%3Afs_feedUpdate%3A%28V2%2Curn%3Ali%3Aactivity%3A6904375228529569792%29" target='_blank' className='bg-gradient-to-t from-green-400 to-primary-color p-1 absolute bottom-0 right-0 text-lg'>
